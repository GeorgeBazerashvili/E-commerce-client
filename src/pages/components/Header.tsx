  ...
  return (
        <header className="flex items-center gap-6 px-5 font-serif w-full fixed justify-between bg-white z-10 max-xl:px-1">
            ...
            <div className="middle-side flex-1 max-w-4xl flex w-4/12 min-w-fit items-center gap-2 max-lg:justify-end">
                <input type="text" 
                       className={`header-input border-2 p-2 text-xl w-full flex1 top-0 relative rounded-md border-gray-200 ${isActive == true ? "active" : ""}`} />
                 <i className="fa-solid cursor-pointer fa-magnifying-glass"
                    onClick={changeActiveness}></i>
            </div>

            <div className="right-side gap-10 flex max-xl:gap-2">

                <div className="gap-2 cursor-pointer items-center flex" onClick={checkCookies}>
